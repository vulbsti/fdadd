    ...
    <article className="container mx-auto max-w-3xl px-4 py-12">
      ...
      {post.imageUrl && (
        <div className="relative mb-8 h-64 w-full overflow-hidden rounded-lg md:h-96">
          <Image
            src={post.imageUrl === '/images/blog1.jpg' || post.imageUrl === '/images/blog2.jpg' ? `https://picsum.photos/1200/800?random=${params.id}` : post.imageUrl }
            alt={post.title}
            layout="fill"
            objectFit="cover"
       ...
       <div className="prose prose-lg dark:prose-invert max-w-none">
           ...
           {/* Render full post.content here. This often involves a Markdown renderer */}
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
             <Image
                 src={`https://picsum.photos/800/500?random=${parseInt(params.id)+10}`}
